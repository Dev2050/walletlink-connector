...
var WalletLinkConnector = /*#__PURE__*/function (_AbstractConnector) {
  ...
  _proto.activate = /*#__PURE__*/function () {
    var _activate = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
      var WalletLink, accounts, account;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _context.next = 7;
              return new Promise(function (resolve) { resolve(_interopNamespace(require('walletlink'))); }).then(function (m) {
                var _m$default;
            ...
            case 7:
              WalletLink = _context.sent;
              this.walletLink = new WalletLink(_extends({
